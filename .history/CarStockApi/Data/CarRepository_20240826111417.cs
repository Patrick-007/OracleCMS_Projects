...
namespace CarStockApi.Data{
    public class CarRepository{
        ...
        private Dictionary<int, List<dynamic>> _dealerStockList;
        ...
        public CarRepository(){
            ...
            _dealerStockList = new Dictionary<int, List<dynamic>>();
        ...
        public IEnumerable<dynamic> GetAll(int dealerId){
            return _dealerStockList.ContainsKey(dealerId) ? _dealerStockList[dealerId] : new List<dynamic>();
        }

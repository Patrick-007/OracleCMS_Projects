        ...
        public CarRepository(){
            _dealerCars = new Dictionary<int, List<Car>>{
                { 
                    ...
                    {
                        new Car { Car_ID = 1, Make = "Audi", Model = "A4", Year = 2018, StockLevel = 5 },
                        new Car { Car_ID = 2, Make = "BMW", Model = "X5", Year = 2020, StockLevel = 3 }
                    }
                },
                { 
                    2, new List<Car> // Dealer with ID 2
                    {
                        new Car { Car_ID = 3, Make = "Tesla", Model = "Model 3", Year = 2021, StockLevel = 10 },
                        new Car { Car_ID = 4, Make = "Mercedes", Model = "C-Class", Year = 2019, StockLevel = 4 }
                    }
                }
            };
        }
